            ...
            $("#loginButtonId").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if ("success" == data) {
                            location.href = "/cmfz/login/index.jsp";
                        } else {
                            $("#msgDiv").text(data);
                            // location.href="/cmfz/login/login.jsp";
                        }
                    },
                    error: function (data) {
                        alert(123);
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form id="myform" role="form" action="${pageContext.request.contextPath}/admin/login"
                              method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/validate/code">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       type="text" name="enCode" id="form-code" required>
                            </div>
